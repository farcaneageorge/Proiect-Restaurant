...
<body>
	...
	Adaugare preparat meniu :
	<br></br>
	<form:form action="./addMeniu.htm" commandName="meniuForm"
		method="post">
					
<table>
  <tr>
  <th>Id   <form:input path="id" /></th>
    <th>Denumire  <form:input path="denumire" /></th> 
    <th>Informati <form:input path="informati" /></th>
    <th>Gramaj/gr<form:input path="gramaj" /></th> 
    <th>Pret/lei<form:input path="pret" /></th>
    <th>Poza<form:input path="imagePath" /></th>
  </tr> 
  <tr>
</table>
