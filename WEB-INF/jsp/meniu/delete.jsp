...
<!-- Header Section -->
    ...
    <div class = "body_sec"> 
        ...
        Stergere preparat :
	<br></br>
	<form:form action="${pageContext.request.contextPath}/deleteMeniu.htm"
		commandName="meniuForm" method="post">
					
Id Preparat : <form:input path="id" />
		<br></br>
Denumire : <form:input path="denumire" />
		<br></br>
Informati preparat : <form:input path="informati" />
		<br></br>
Gramaj : <form:input path="gramaj" />
		<br></br>
Pret : <form:input path="pret" />
		<br></br>
