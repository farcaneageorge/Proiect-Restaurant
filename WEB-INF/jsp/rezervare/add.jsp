...
<body>
	...
	<form:form action="./addRezervare.htm" commandName="rezervareForm"
		method="post">
					
<table>
  <tr>
  <th>Id Client  <form:input path="id" /></th>
    <th>Nume<form:input path="nume" /></th> 
    <th>Prenume: <form:input path="prenume" /></th>
    <th>Numar Telefon<form:input path="nrTelefon" /></th> 
    <th>Informatii rezervare<form:input path="infoRezervare" /></th>
  </tr> 
  <tr>
</table>
