...
<body>
 ...
 <!-- Header Section -->
	...
	<form:form action="${pageContext.request.contextPath}/editRezervare.htm" commandName="rezervareForm" method="post">
...
Prenume : <form:input path="prenume" />
		<br></br>
Numar telefon : <form:input path="nrTelefon" />
		<br></br>
Informatii rezervare : <form:input path="infoRezervare" />
		<br></br>
