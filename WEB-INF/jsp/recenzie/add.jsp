...
<body>
	...
	Adaugare recenzie :
	<br></br>
	<form:form action="./addRecenzie.htm" commandName="recenzieForm"
		method="post">
...
<table>
  ...
  <th>Id   <form:input path="id" /></th>
    <th>Data
    <form:input path="data" /></th> 
    <th>Nume <form:input path="nume" /></th>
    <th>Detalii<form:input path="detalii" /></th> 
    <th>Punctaj&#9733; <form:input path="punctaj" /></th>
  </tr> 
  <tr>
</table>
