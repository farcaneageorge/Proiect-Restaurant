...
<body>
 <!-- Header Section -->
	...
	Detaliile recenziei sunt:
	<br></br>
	<table>
		<tr>
			<td>Id</td>
			<td><c:out value="${model.recenzie.id }" /></td>
		</tr>
		<tr>
			<td>Data</td>
			<td><c:out value="${model.recenzie.data}" /></td>
		</tr>
		<tr>
			<td>Nume</td>
			<td><c:out value="${model.recenzie.nume}" /></td>
		</tr>
		<tr>
			<td>Detalii</td>
			<td><c:out value="${model.recenzie.detalii }" /></td>
		</tr>
		<tr>
			<td>Punctaj &#9733;</td>
			<td><c:out value="${model.recenzie.punctaj }" /></td>
		</tr>
	</table>
	<a href="<c:url value="/recenzi.htm"/>">Inapoi la lista</a>
